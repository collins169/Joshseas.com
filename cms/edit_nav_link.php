<?php 
    include ('functions/add_nav_link.php'); 
    GLOBAL $alert; 
?>
<!DOCTYPE html>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>CMS | Edit Navigation Link</title>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title"> Navigation Link
                        <small>Add Nagivation Link for the main website</small>
                    </h1>
                    <div class="page-bar">
                             ...
                             <div class="portlet light form-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase">Edit Navigation Link</span>
                                    </div>
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form method='post' class="form-horizontal form-bordered">
                                        <?php 
                                            ...
                                            if (isset($_GET['edit'])) {
                                                $id=$_GET['edit'];
                                                $check=mysqli_query($connect, "SELECT * FROM navigations WHERE id=$id")or die('Unable to process request');
                                                if(mysqli_num_rows($check)>0){ 
                                                    foreach ($check as $info ) {
                                        echo '
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Navigation Name</label>
                                                <div class="col-md-6">
                                                     <input type="text" class="form-control" name="nav_title" value="'.$info['title'].'">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Navigation Path</label>
                                                <div class="col-md-6">
                                                     <input type="text" class="form-control" name="nav_path" value="'.$info['path'].'">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-6">
                                                    ...
                                                    <a href="nav_link.php" class="btn btn-outline grey-salsa">Cancel</a>
                                                </div>
                                            </div>
                                        </div>';}
                                            }else{
