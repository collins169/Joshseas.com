                                           ...
                                           if (isset($_GET['id'])) {
                                                ...
                                                if(mysqli_num_rows($check)>0){ 
                                                    foreach ($check as $info ) {
                                                        $check2=mysqli_query($connect, "SELECT * FROM categories WHERE id=$info[cat_id]")or die('Unable to process request');
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>Logo</th>
                                                        <td class='center'><img src='$info[image]' width='300px' alt='$info[image_caption]'></td> 
                                                    </tr>
                                                    <tr>
                                                        <th>Created Date</th>
