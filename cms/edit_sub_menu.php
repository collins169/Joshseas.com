<?php 
    include ('functions/add_sub_menu.php'); 
    GLOBAL $alert; 
?>
<!DOCTYPE html>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <!-- BEGIN PAGE HEADER-->
                    <h1 class="page-title"> Sub Menu
                        <small>Add Sub Menu for the main website</small>
                    </h1>
                    <div class="page-bar">
                             ...
                             <div class="portlet light form-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase">Edit Sub Menu</span>
                                    </div>
                                    <div class="caption pull-right">
                                        <a href="sub_menus.php" class="btn green"><i class='icon-arrow-left'></i> Back</a>
                                    </div>
                                </div>
                                <div class="portlet-body form">
                                    ...
                                    <form method='post' class="form-horizontal form-bordered">
                                        <?php 
                                            ...
                                            if (isset($_GET['edit'])) {
                                                $id=$_GET['edit'];
                                                $check=mysqli_query($connect, "SELECT * FROM sub_menus WHERE id=$id")or die('Unable to process request');
                                                if(mysqli_num_rows($check)>0){ 
                                                    foreach ($check as $info1 ) {
                                        ?>
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Sub Menu Name</label>
                                                <div class="col-md-6">
                                                     <input type="text" class="form-control" name="nav_title" value="<?php echo $info1['title'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                         <div class="form-body">
                                            ...
                                            //SELECTING THE TITLE OF THE SELECTED NAVIGATION ID IN THE CONTENT TABLE
                                                $sql=mysqli_query($connect, "SELECT *  FROM sub_menus LEFT JOIN navigations ON (sub_menus.menu_id = navigations.id)  WHERE navigations.id = $info1[menu_id]")or die('unable to process request');
                                                $me=mysqli_fetch_array($sql);
                                                $check=mysqli_query($connect, "SELECT * FROM navigations")or die('unable to process request');
                                                if(mysqli_num_rows($check)>0){ ?>

                                                <label class="control-label col-md-3">Menu Category</label>
                                                <div class="col-md-6">
                                                    <select class="form-control" required name='menu_id'>
                                                        <option value='<?php echo $me['menu_id'] ?>' selected><?php echo $me['title'] ?></option>
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Sub Menu Path</label>
                                                <div class="col-md-6">
                                                     <input type="text" class="form-control" name="nav_path" value="<?php echo $info1['path'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-6">
                                                    ...
                                                    <a href="sub_menus.php" class="btn btn-outline grey-salsa">Cancel</a>
                                                </div>
                                            </div>
                                        </div><?php }
                                            }else{
                                                echo "<script>alert('Invaild Sub Menu')
                                                window.location.href='sub_menus.php'</script>
                                                        ";
                                            }
                                        }?>
                                    </form>
