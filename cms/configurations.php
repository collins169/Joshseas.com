...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>CMS | Website Configuration</title>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title"> Configuration
                        <small>Configure the main website social links</small>
                    </h1>
                    <div class="page-bar">
                             ...
                             <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase">View Settings</span>
                        ...
                        <div class="row">
                            <div class="col-md-11">
                                    <div class="portlet-body">
                                        ...
                                        echo '<div><a href="add_configuration.php" class="btn green"><i class="icon-plus"></i> Add Configuration</a></div><br>';
                                        }else{ echo '';}?>
                                        <table class='table table-bordered table-responsive table-stripped table-hover'>
                                            <thead>
                                             ...
                                             <?php 
                                                $check=mysqli_query($connect, "SELECT * FROM settings")or die('unable to process request');
                                                $j=1;
                                                ...
                                                <tbody>
                                                 <?php 
                                                    ...
                                                    $action="<td><a href='edit_configuration.php?edit=$info[id]'><i class='icon-note'></i> Edit</a> &nbsp; <a href='#'><i class='icon-trash'></i> Delete</a></td>";
                                                }else{
                                                    $action="";
                                                }
                                                                        echo" 
