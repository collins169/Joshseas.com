                             ...
                             <div class="portlet light form-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase">Add New Slider</span>
                                    </div>
                                </div>
                                    ...
                                    <form method='post' class="form-horizontal form-bordered" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="text" class="form-control" name='slider_caption' placeholder="Enter the Image Caption" required>
                                                </div>
                                            </div>
                                        </div>
