<?php 
    include ('functions/add_category.php'); 
    GLOBAL $alert; 
?>
<!DOCTYPE html>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title"> Category
                        <small>Add Category for the main website</small>
                    </h1>
                    <div class="page-bar">
                             ...
                             <div class="portlet light form-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase">Add New Category</span>
                                    </div>
                                </div>
