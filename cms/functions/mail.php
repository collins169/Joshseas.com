...
$mail->setFrom('no-reply@joshseas.com', "Joshseas.com");    // Add a recipient
	...
	<tr><td align="center" bgcolor="#ffffff">
		...
		<table width="90%" border="0" cellspacing="0" cellpadding="0">
			<tr><td align="left"><!-- 
				...
				<![endif]-->
				<!-- Item -->
				<div style="line-height: 44px; text-align: center; margin-top: 30px; margin-bottom: 0px">
					<font face="montserrat, sans-serif" size="5" color="#57697e" style="font-size: 20px;">
					<span style="font-family: montserrat, sans-serif; font-size: 20px; color: #000; font-weight: bold;">
						New Blog Post!
					</span></font>
			...
			<tr><td align="">
				<div style="line-height: 24px;">
					<a href="#" target="_blank" style="color: #596167; font-family: montserrat, sans-serif; font-size: 13px;">
						<font face="montserrat, sans-seri; font-size: 13px;" size="3" color="#596167">
							<img src="https://www.joshseas.com/cms/$picture" width="650" height="350" alt="success" border="0" style="display: block;" /></font></a>
				</div>
				<!-- padding --><div style="height: 60px; line-height: 60px; font-size: 10px;"> </div>
			</td></tr>
			<tr><td align="center">
				<div style="line-height: 24px;">
					...
					</span></font><a href="https://www.joshseas.com/blog_post?id=$id" style="text-decoration: none;"><p style="color: #000; font-family: montserrat, sans-serif; font-size: 13px; border: 1px solid #000; border-radius: 10px; width: 100px;margin-top: 30px ">Read More..</p></a>
				</div>
...
$mail->AltBody = "<h3><strong>$subject</strong></h3><br>
				<p><img href='https://www.joshseas.com/cms/$picture' width='650' height='350' ></p>
				<p>$body ...</p>
";
