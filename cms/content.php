<?php 
    include('functions/db.php'); 
        if (isset($_GET['delete'])) {
                ...
                $delete=mysqli_query($connect, "DELETE FROM contents WHERE id=$id")or die("Unable to process request");
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title"> Content
                        <small>Edit, Add and Delete Contents for the main website</small>
                    </h1>
                    <div class="page-bar">
                    ...
                    <div class="row">
                             ...
                             <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase">View Contents</span>
                        ...
                        <div class="row">
                            <div class="col-md-11">
                                    <div class="portlet-body">
                                        <div><a href="add_content.php" class="btn green"><i class='icon-plus'></i> Add Content</a></div><br>
                                        <table class='table table-bordered table-responsive table-stripped table-hover' id='sample_1'>
                                            ...
                                            <?php 
                                                $check=mysqli_query($connect, "SELECT * FROM contents WHERE deleted=0 ORDER BY created DESC")or die('unable to process request');
                                                $j=1;
                                                if(mysqli_num_rows($check)>0){ ?>
                                                <tbody>
                                                  ...
                                                  <tr>
                                                      <td>$j</td>
                                                      <td class='center'><a href='$info[image]' data-lightbox='mygallery'><img src='".$info['image']."' width='100px' alt='".$info['image_caption']."'></a></td> 
                                                      <td>".$info['title']."</td>
                                                      <td>".date('d-M-Y | g:i a', ($info['created']))."</td>
                                                      <td>".date('d-M-Y | g:i a', ($info['modified']))."</td>
                                                      <td><a href='view_content.php?id=$info[id]'><i class='icon-eye'></i> View</a> &nbsp; <a href='edit_content.php?edit=$info[id]'><i class='icon-note'></i> Edit</a> &nbsp; <a href='content.php?delete=$info[id]' onclick='javascript:confirmationDelete($(this));return false;'><i class='icon-trash'></i> Delete</a></td>
                                                  </tr>"; $j++;}?> 
