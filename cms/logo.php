...
if (isset($_GET['delete'])) {
        ...
        $delete=mysqli_query($connect, "DELETE FROM logos WHERE id=$id")or die("Unable to process request");
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title"> Logo
                        <small>Edit, Add and Delete Logo for the main website</small>
                    </h1>
                    <div class="page-bar">
                             ...
                             <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase">View Logo</span>
                        ...
                        <div class="row">
                            <div class="col-md-11">
                                    <div class="portlet-body table-both-scroll">
                                        <div><a href="add_logo.php" class="btn green"><i class='icon-plus'></i> Add Logo</a></div><br>
                                        <table class='table table-bordered table-responsive table-stripped table-hover order-column' id="sample_4">
                                            ...
                                            <thead>
                                              ...
                                              <?php 
                                                $check=mysqli_query($connect, "SELECT * FROM logos")or die('unable to process request');
                                                $j=1;
                                                if(mysqli_num_rows($check)>0){ ?>
                                                <tbody>
                                                  <?php foreach ($check as $info ) {
                                                    if($info['status']==1){
                                                        $status="<a href='logo.php?deactivate=$info[id]' ><span class='label label-md label-danger'>Deactivate</span></a>";
                                                    }else{
                                                        $status="<a href='logo.php?activate=$info[id]' ><span class='label label-md label-success'>Activate</span></a>";
                                                    }
                                                                        echo" 
                                                  <tr>
                                                      <td>$j</td>
                                                      <td class='center'><img src='".$info['logo']."' width='100px' alt='".$info['logo_caption']."'></td> 
                                                      <td>".date('d-M-Y | g:i a', ($info['created']))."</td>
                                                      <td>".date('d-M-Y | g:i a', ($info['modified']))."</td>
                                                      <td><a href='view_logo.php?id=$info[id]'><i class='icon-eye'></i> View</a> &nbsp; <a href='edit_logo.php?edit=$info[id]'><i class='icon-note'></i> Edit</a> &nbsp; <a href='logo.php?delete=$info[id]' onclick='javascript:confirmationDelete($(this));return false;'><i class='icon-trash'></i> Delete</a></td>
                                                      <td> $status</td>  
                                                  </tr>";  $j++;}; ?>
