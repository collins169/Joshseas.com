<!DOCTYPE html>
<?php GLOBAL $alert2; include 'functions/db.php';
    include 'functions/add_user.php'; ?>
<html lang="en">
    <!--<![endif]-->
    <!-- BEGIN HEAD -->
                            ...
                            <div class="profile-sidebar">
                                ...
                                <div class="portlet light profile-sidebar-portlet ">
                                    ...
                                    <div class="profile-userpic">
                                        <img src="<?php echo $profile; ?>" class="img-responsive" alt="" width='400px'> </div>
                                    <!-- END SIDEBAR USERPIC -->
                                    <!-- SIDEBAR USER TITLE -->
                                                    ...
                                                    <div class="tab-pane active" id="tab_1_1">
                                                        <form role="form" action="#">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" placeholder="<?php echo $firstname; ?>" readonly class="form-control" /> </div>
                                                            <div class="form-group">
                                                                <label class="control-label">Last Name</label>
                                                                <input type="text" placeholder="<?php echo $lastname; ?>" class="form-control" readonly /> </div>
                                                            <div class="form-group">
                                                                <label class="control-label">Username</label>
                                                                <input type="text" placeholder="<?php echo $username; ?>" class="form-control" readonly /> </div>
                                                            <div class="form-group">
                                                                <label class="control-label">Email Address</label>
                                                                <input type="email" placeholder="<?php echo $email; ?>" class="form-control" readonly/> </div>
                                                            <div class="form-group">
                                                                <label class="control-label">User Role</label>
                                                                <input type="text" placeholder="<?php echo $role; ?>" class="form-control" readonly /> </div>
                                                    ...
                                                    <div class="tab-pane" id="tab_1_3">
                                                        <form method="post">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="password" name='old_password' class="form-control" required title='Please enter your old password' /> </div>
                                                            <div class="form-group">
                                                                <label class="control-label">New Password</label>
                                                                <input type="password" name='password' class="form-control" required title='Please enter your new password'/> </div>
                                                            <div class="form-group">
                                                                <label class="control-label">Re-type New Password</label>
                                                                <input type="password" name='password2' class="form-control" required title='Please confirm your new password'/> </div>
                                                            <div class="margin-top-10">
                                                                <button type="submit" name='change_password' class="btn green"> Change Password </button>
                                                                <a href="user_profile.php" class="btn default"> Cancel </a>
                                                            </div>
                                                        </form>
                                                    </div>
