                             ...
                             <div class="portlet light ">
                                <div class="portlet-title">
                                    ...
                                    <div class="caption pull-right">
                                        <a href="content.php" class="btn green"><i class='icon-arrow-left'></i> Back</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-11">
                                    <div class="portlet-body">
                                        <table class='table table-bordered table-responsive table-stripped '>
                                           ...
                                           if (isset($_GET['id'])) {
                                                $id=$_GET['id'];
                                                $check=mysqli_query($connect, "SELECT * FROM contents WHERE id=$id AND deleted=0")or die('Unable to process request');
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>Image</th>
                                                        <td class='center'><a href='$info[image]' data-lightbox='mygallery'><img src='$info[image]' width='300px' alt='$info[image_caption]'></a></td> 
                                                    </tr>
                                                    <tr>
                                                        <th>Summary</th>
                                                        <td>$info[summary]</td>
