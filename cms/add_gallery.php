            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title"> Gallery
                        <small>Add Gallery for the main website</small>
                    </h1>
                    <div class="page-bar">
                             ...
                             <div class="portlet light form-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase">Add New Gallery</span>
                                    </div>
                                </div>
                                    ...
                                    <form method='post' class="form-horizontal form-bordered" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="text" class="form-control" name='gallery_caption' placeholder="Enter the Image Caption" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                                        ...
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            ...
                                                            <div>
                                                                <span class="btn default btn-file">
                                                                    ...
                                                                    <input type="file" accept="image/jpg, image/jpeg, image/png" name="gallery" required> </span>
