...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>CMS | Add Configuration</title>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title"> Configuration
                        <small>Add Setting for the main website</small>
                    </h1>
                    <div class="page-bar">
                             ...
                             <div class="portlet light form-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase">Add New Settings</span>
                                    </div>
                                </div>
                                    ...
                                    <form method='post' class="form-horizontal form-bordered">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="url" class="form-control" name='twitter' placeholder="Enter Twitter Url">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="url" class="form-control" name='google' placeholder="Enter Google Plus Url">
                                                </div>
                                            </div>
                                        </div>
