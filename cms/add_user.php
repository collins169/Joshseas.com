        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- BEGIN THEME PANEL -->
                    <!-- END THEME PANEL -->
                    <h1 class="page-title"> Add New User | Account
                                            ...
                                            <div class="portlet-body">
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane active" id="tab_1_1">
                                                        <form role="form" method="post" >
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" placeholder="Enter First Name" class="form-control" required name='first_name' /> </div>
                                                            <div class="form-group">
                                                                <label class="control-label">Last Name</label>
                                                                <input type="text" placeholder="Enter Last Name" class="form-control" required name='last_name' /> </div>
                                                            <div class="form-group">
                                                                <label class="control-label">Username</label>
                                                                <input type="text" placeholder="Enter Username" class="form-control" required name='username' /> </div>
                                                            <div class="form-group">
                                                                <label class="control-label">Email Address</label>
                                                                <input type="email" placeholder="Enter Email Address" class="form-control" required name='email'/> </div>
                                                            <div class="form-group">
                                                                <label class="control-label">Password</label>
                                                                <input type="password" placeholder="Enter Password" class="form-control" required name='password' id='password' />
                                                                <span id="pwdMeter" class="neutral"></span> </div>
                                                            <div class="form-group">
                                                    ...
                                                    <div class="tab-pane" id="tab_1_2">
                                                        <?php include 'functions/profile_pic.php'; echo $alert; ?>
