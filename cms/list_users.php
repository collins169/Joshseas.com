...
if (isset($_GET['delete'])) {
        ...
        $delete=mysqli_query($connect, "UPDATE users SET active=1 WHERE id=$id")or die("Unable to process request");
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Joshseas | List Users</title>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title"> List User
                        <small>Edit, Add and Delete Users</small>
                    </h1>
                    <div class="page-bar">
                    ...
                    <div class="row">
                             ...
                             <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase">List Users</span>
                        ...
                        <div class="row">
                            <div class="col-md-11">
                                    <div class="portlet-body">
                                        <?php global $action, $title,$info;
                                         if($role=='administrator'){ echo'
                                        <div><a href="add_user.php" class="btn green"><i class="icon-plus"></i> Add New User</a></div><br>';$title="<th>Action</th>"; $action="<td><a href='edit_user.php?edit=$info[id]'><i class='icon-note'></i> Edit</a> &nbsp; <a href='#'><i class='icon-trash'></i> Delete</a></td>"; }else{ echo''; $tite=''; $action='';}?>
                                        <table class='table table-bordered table-responsive table-stripped table-hover' width="100%" id="sample_1">
                                           ...
                                           <thead>
                                             ...
                                             <?php
                                            $check=mysqli_query($connect, "SELECT * FROM users WHERE active=1")or die('unable to process request');
                                                $j=1;
