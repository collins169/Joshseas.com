...
if (isset($_GET['delete'])) {
        ...
        $check=mysqli_query($connect, "SELECT * FROM sliders WHERE id=$id")or die("Unable to process request");
        if(mysqli_num_rows($check)>0){
            $info=mysqli_fetch_array($check);
        }
        $path=$info['slider'];

        $delete=mysqli_query($connect, "DELETE FROM sliders WHERE id=$id")or die("Unable to process request");
...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="assets/global/css/lightbox.min.css">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title"> Slider
                        <small>Edit, Add and Delete Slider for the main website</small>
                    </h1>
                    <div class="page-bar">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-11">
                                    <div class="portlet-body">
                                        <div><a href="add_slider.php" class="btn green"><i class='icon-plus'></i> Add Slider</a></div><br>
                                        <table class='table table-bordered table-responsive table-stripped table-hover dt-responsive' id=sample_1>
                                            ...
                                            <thead>
                                             ...
                                             <?php 
                                                $check=mysqli_query($connect, "SELECT * FROM sliders ORDER BY created DESC")or die('unable to process request');
                                                $j=1;
                                                if(mysqli_num_rows($check)>0){ ?>
                                                <tbody>
                                                  ...
                                                  <tr>
                                                      <td>$j</td>
                                                      <td class='center'><a href='$info[slider]' data-lightbox='mygallery'><img src='".$info['slider']."' width='100px' alt='".$info['slider_caption']."'></a></td> 
                                                      <td>".date('d-M-Y | g:i a', ($info['created']))."</td>
                                                      <td>".date('d-M-Y | g:i a', ($info['modified']))."</td>
                                                      <td><a href='view_slider.php?id=$info[id]'><i class='icon-eye'></i> View</a> &nbsp; <a href='edit_slider.php?edit=$info[id]'><i class='icon-note'></i> Edit</a> &nbsp; <a href='slider.php?delete=$info[id]' onclick='javascript:confirmationDelete($(this));return false;'><i class='icon-trash'></i> Delete</a></td>
                                                  </tr>";$j++;}; ?>
...
<![endif]-->
            <!-- BEGIN CORE PLUGINS -->
            <script src="assets/global/scripts/lightbox-plus-jquery.min.js"></script>
