<?php include('functions/add_slider.php');
global $alert;?>
<!DOCTYPE html>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title"> Slider
                        <small>Add Slider for the main website</small>
                    </h1>
                    <div class="page-bar">
                             ...
                             <div class="portlet light form-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase">Edit Slider</span>
                                    </div>
                                    <div class="caption pull-right">
                                        <a href="slider.php" class="btn green"><i class='icon-arrow-left'></i> Back</a>
                                    </div>
                                </div>
                                    ...
                                    <form method='post' class="form-horizontal form-bordered" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Slider Caption</label>
                                                <div class="col-md-6">
                                                     <input type="text" class="form-control" name="slider_caption" value="'.$info['slider_caption'].'" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <img src="'.$info['slider'].'" width="200px">
                                                </div>
                                            </div>
                                        <div class="form-group last">
                                                <label class="control-label col-md-3">Slider Upload </label>
                                                <div class="col-md-6">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        ...
                                                        <div>
                                                            <span class="btn default btn-file">
                                                                ...
                                                                <input type="file" accept="image/jpg, image/jpeg, image/png" name="slider" required> </span>
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                ...
                                                echo "<script>alert('Invaild slider')
