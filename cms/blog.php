...
if (isset($_GET['delete'])) {
        ...
        $delete=mysqli_query($connect, "DELETE FROM blogs WHERE id=$id")or die("Unable to process request");
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title"> Blog
                        <small>Edit, Add and Delete Blog Posts for the main website</small>
                    </h1>
                    <div class="page-bar">
                    ...
                    <div class="row">
                             ...
                             <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase">View Blogs</span>
                        ...
                        <div class="row">
                            <div class="col-md-11">
                                    <div class="portlet-body">
                                        <div><a href="add_blog.php" class="btn green"><i class='icon-plus'></i> Add Blog</a></div><br>
                                        <table class='table table-bordered table-responsive table-stripped table-hover' width='100%' id="sample_1">
                                            ...
                                            <?php 
                                                $check=mysqli_query($connect, "SELECT * FROM blogs WHERE deleted=0 ORDER BY created DESC" )or die('unable to process request');
                                                $j=1;
                                                if(mysqli_num_rows($check)>0){ ?>
                                                <tbody>
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td><a href='view_blog.php?id=$info[id]'><i class='icon-eye'></i> View</a> &nbsp; <a href='edit_blog.php?edit=$info[id]'><i class='icon-note'></i> Edit</a> &nbsp; <a href='blog.php?delete=$info[id]' onclick='javascript:confirmationDelete($(this));return false;><i class='icon-trash'></i> Delete</a></td>
                                                  </tr>"; $j++;}; ?>
