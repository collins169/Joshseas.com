            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title"> Gallery
                        <small>Edit, Add and Delete Picture for the gallery in the main website</small>
                    </h1>
                    <div class="page-bar">
                    ...
                    <div class="row">
                             ...
                             <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase">View Gallery</span>
                        ...
                        <div class="row">
                            <div class="col-md-11">
                                    <div class="portlet-body">
                                        <div><a href="add_gallery.php" class="btn blue"><i class='icon-plus'></i> Add Gallery</a> <a href="add_category.php" class="btn green"><i class='icon-plus'></i> Add Category</a></div><br>
                                        <table class='table table-bordered table-responsive table-stripped table-hover' width="100%" id="sample_1">
                                            ...
                                            <?php 
                                                $check=mysqli_query($connect, "SELECT * FROM galleries ORDER BY created DESC")or die('unable to process request');
                                                $j=1;
                                                if(mysqli_num_rows($check)>0){ ?>
                                                <tbody>
                                                 <?php foreach ($check as $info ) {
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td><a href='view_gallery.php?id=$info[id]'><i class='icon-eye'></i> View</a> &nbsp; <a href='edit_gallery.php?edit=$info[id]'><i class='icon-note'></i> Edit</a> &nbsp; <a href='gallery.php?delete=$info[id]' onclick='javascript:confirmationDelete($(this));return false;'><i class='icon-trash'></i> Delete</a></td>
                                                  </tr>"; $j++;}; ?>
