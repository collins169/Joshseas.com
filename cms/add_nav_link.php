...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>CMS | Add Navigation Link</title>
                             ...
                             <div class="portlet light form-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase">Add New Navigation Link</span>
                                    </div>
                                </div>
                                    ...
                                    <form method='post' class="form-horizontal form-bordered">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="text" class="form-control" name='nav_title' placeholder="Enter the Navigation Link Name">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="text" class="form-control" name='nav_path' placeholder="Enter the Navigation Link Path">
                                                </div>
                                            </div>
                                        </div>
