<?php 
    include ('functions/add_configuration.php'); 
    GLOBAL $alert; 
?>
<!DOCTYPE html>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title"> Configuration
                        <small>Edit Configuration for the main website</small>
                    </h1>
                    <div class="page-bar">
                             ...
                             <div class="portlet light form-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase">Edit Configuration</span>
                                    </div>
                                    <div class="caption pull-right">
                                        <a href="nav_link.php" class="btn green"><i class='icon-arrow-left'></i> Back</a>
                                    </div>
                                </div>
                                <div class="portlet-body form">
                                    ...
                                    <form method='post' class="form-horizontal form-bordered">
                                        <?php 
                                            ...
                                            if (isset($_GET['edit'])) {
                                                $id=$_GET['edit'];
                                                $check=mysqli_query($connect, "SELECT * FROM settings WHERE id=$id")or die('Unable to process request');
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="url" class="form-control" name='website' value="<?php echo $info['website'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="text" class="form-control" name='country' value="<?php echo $info['country'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="tel" class="form-control" name='phone' value="<?php echo $info['phone'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="email" class="form-control" name='email' value="<?php echo $info['email_address'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="url" class="form-control" name='facebook' value="<?php echo $info['facebook_url'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="url" class="form-control" name='twitter' value="<?php echo $info['twitter_url'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="url" class="form-control" name='instagram' value="<?php echo $info['instagram_url'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Google Plus Url</label>
                                                <div class="col-md-6">
                                                     <input type="url" class="form-control" name='google' value="<?php echo $info['googleplus_url'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-6">
                                                    ...
                                                    <a href="configurations.php" class="btn btn-outline grey-salsa">Cancel</a>
                                                </div>
                                            </div>
                                        </div>
                                        <?php }
                                            }else{
                                                echo "<script>alert('Invaild Navigation link')
                                                window.location.href='nav_link.php'</script>
                                                        ";
                                            }
                                        }?>
                                    </form>
