                             ...
                             <div class="portlet light form-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase">Add New Sub Menu</span>
                                    </div>
                                </div>
                                    ...
                                    <form method='post' class="form-horizontal form-bordered">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="text" class="form-control" name='nav_title' placeholder="Enter the Sub Menu Name">
                                                </div>
                                            </div>
                                        </div>
                                         <div class="form-body">
                                            ...
                                            <?php 
                                                ...
                                                <div class="col-md-6">
                                                    <select class="form-control" required name='menu_id'>
                                                        <option name=''> --- Select Menu --- </option>
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="text" class="form-control" name='nav_path' placeholder="Enter the Sub menu Path">
                                                </div>
                                            </div>
                                        </div>
