<?php 
    include('functions/add_gallery.php'); 
    GLOBAL $alert;
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title"> Gallery
                        <small>Edit Gallery for the main website</small>
                    </h1>
                    <div class="page-bar">
                             ...
                             <div class="portlet light form-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase">Edit Gallery</span>
                                    </div>
                                    <div class="caption pull-right">
                                        <a href="gallery.php" class="btn green"><i class='icon-arrow-left'></i> Back</a>
                                    </div>
                                </div>
                                <div class="portlet-body form">
                                    ...
                                    <form method='post' class="form-horizontal form-bordered" enctype="multipart/form-data">
                                        <?php 
                                            ...
                                            if (isset($_GET['edit'])) {
                                                $id=$_GET['edit'];
                                                $check=mysqli_query($connect, "SELECT * FROM galleries WHERE id=$id")or die('Unable to process request Gallery');
                                                $s=mysqli_fetch_assoc($check);
                                                $cat_id=$s['cat_id'];
                                                $check2=mysqli_query($connect, "SELECT * FROM categories WHERE id=$cat_id")or die('Unable to process request Catergory');
                                                $cat=mysqli_fetch_assoc($check2);
                                ...
                                $check=mysqli_query($connect, "SELECT * FROM categories ORDER BY name ASC");
                                foreach($check as $get){
                            ?> 
                            
                            <?php if($get['name']==$cat['name']){ ?>
                            ...
                            <?php } ?>
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="text" class="form-control" name="gallery_caption" value="<?php echo $info['image_caption']?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <img src="<?php echo$info['image'] ?>" width="200px">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                            <div class="form-group">
                                                    <label class="control-label col-md-3">Select New image</label>
                                                    <div class="col-md-6">
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            ...
                                                            <div>
                                                                <span class="btn default btn-file">
                                                                    ...
                                                                    <input type="file" accept="image/jpg, image/jpeg, image/png" name="gallery" > </span>
                                                                <a href="javascript:;" class="btn red fileinput-exists" data-dismiss="fileinput"> Remove </a>
                                                            </div>
                                                        </div>
                                                        <div class="clearfix margin-top-10">
                                                            <span class="label label-danger">NOTE!</span>&nbsp; Image file format must be either jpg, jpeg or png extension </div>
                                                    </div>
                                                </div>
                                            </div>
                                                <div class="form-group last">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            if ($info['status']==1) {
                                                             ...
                                                             ?>
                                                                <option value='<?php echo $info['status'] ?>' selected='selected'> <?php echo $title ?></option>
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-6">
                                                    ...
                                                    <a href="gallery.php" class="btn btn-outline grey-salsa">Cancel</a>
                                                </div>
                                            </div>
                                        </div><?php }
                                            }else{
                                                echo "<script>alert('Invaild gallery')
