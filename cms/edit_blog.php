                             ...
                             <div class="portlet light form-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase">Edit Blog</span>
                                    </div>
                                    <div class="caption pull-right">
                                        <a href="blog.php" class="btn green"><i class='icon-arrow-left'></i> Back</a>
                                    </div>
                                </div>
                                    ...
                                    <form method='post' class="form-horizontal form-bordered" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <textarea class="form-control" name="summary" rows="6" style="resize: none;" ><?php echo $info['summary'] ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <textarea class="ckeditor form-control" name="content" rows="7" style="resize: none;"  ><?php echo $info['content'] ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="text" class="form-control" name="image_caption" value="<?php echo $info['image_caption'] ?>" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                ...
                                                echo "<script>alert('Invaild Blog')
