<?php 
    include('functions/add_content.php');
    GLOBAL $alert; 
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title"> Content
                        <small>Add Contents for the main website</small>
                    </h1>
                    <div class="page-bar">
                             ...
                             <div class="portlet light form-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red bold uppercase">Edit Content</span>
                                    </div>
                                </div>
                                    ...
                                    <form method='post' class="form-horizontal form-bordered" enctype="multipart/form-data">
                                        <?php 
                                            ...
                                            if (isset($_GET['edit'])) {
                                                ...
                                                if(mysqli_num_rows($check)>0){ 
                                                    foreach ($check as $info1 ) { ?>
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Title</label>
                                                <div class="col-md-6">
                                                     <input type="text" class="form-control" name='title' value="<?php echo $info1['title']; ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                         <div class="form-body">
                                            <div class="form-group">
                                            <?php 
                                            //SELECTING THE TITLE OF THE SELECTED NAVIGATION ID IN THE CONTENT TABLE
                                                $sql=mysqli_query($connect, "SELECT *  FROM contents LEFT JOIN navigations ON (contents.menu_id = navigations.id)  WHERE navigations.id = $info1[menu_id]")or die('unable to process request');
                                                ...
                                                <div class="col-md-6">
                                                    <select class="form-control" required name='menu_id'>
                                                        <option value='<?php echo $me['menu_id'] ?>'><?php echo $me['title'] ?></option>
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <textarea class='form-control' name='summary' rows="6" style="resize: none;" required><?php echo $info1['summary']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <textarea class="ckeditor form-control" name="content" rows="7" style="resize: none;" required><?php echo $info1['content']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <img src="<?php echo $info1['image']; ?>" width="200px" alt="<?php echo $info1['image_caption']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="text" class="form-control" name='image_caption' value="<?php echo $info1['image_caption']; ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                                ...
                                                <div class="form-group last">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            if ($info1['status']==1) {
                                                             ...
                                                             ?>
                                                                <option value='<?php echo $info1['status'] ?>' selected='selected'> <?php echo $title ?></option>
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-6">
                                                    ...
                                                    <a href="content.php" class="btn btn-outline grey-salsa">Cancel</a>
                                                </div>
                                            </div>
                                        </div><?php } }
                                            }else{
                                                echo "<script>alert('Invaild Content')
