...
//////////////////////////////////// Options ////////////////////////////////////
$url = "https://www.joshseas.com/"; //The Url of the site - the last '/' is needed
...
$always_ignore = array(
	'nav-bg.svg','loading.gif','google48533112b47b86e4.html','.htaccess.php','joshseas.sql'
);

//These files will not be linked in the sitemap.
$ignore_files = array(
	'ajax.php','body.php','comment.php','contact_form.php','count.php','count2.php','mail.php','subscribe.php','google48533112b47b86e4.html','.htaccess.php','joshseas.sql','create_sitemap.php','robots.txt','sitemap.xml'
);

//The script will not enter these folders
$ignore_folders = array(
	'Fonts','function','images','PHPMailer','site','js','css','cms','favicon','img'
);
